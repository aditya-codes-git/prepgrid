...
// -------------------------------------------------------------------------
// 3. MAIN COMPONENT — Customized for PrepGrid
// -------------------------------------------------------------------------
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>AI Mock Interviews</span> <span className="text-primary/60">✦</span>
    <span>Personalized Feedback</span> <span className="text-secondary/60">✦</span>
    <span>200+ Questions</span> <span className="text-primary/60">✦</span>
    <span>Top Tech Companies</span> <span className="text-secondary/60">✦</span>
    <span>Land Your Dream Job</span> <span className="text-primary/60">✦</span>
  </div>
);
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-5xl md:text-8xl font-black footer-text-glow tracking-tighter mb-12 text-center py-2 leading-[1.1]"
            >
              Ready to ace it?
            </h2>
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="#cta" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:grid md:grid-cols-3 items-center gap-6">
            
            {/* Copyright */}
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1 md:text-left text-center">
            ...
            <div className="flex justify-center order-1 md:order-2">
              <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 cursor-default border-border/50">
                ...
                <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">PrepGrid</span>
              </div>
            </div>
